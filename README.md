...
18)	N_stadi_assorbimentoKremser
...
21)	X1_strippingKremser_cascateLineari
...
32) N_stadi_crossFlow_cascateLineari(E As Double, K As Double, YN As Double, Y0 As Double, X0 As Double)
